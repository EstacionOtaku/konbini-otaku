...
const heroData = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1608874973277-a34ed4aba3f8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80",
    linkId: `series/${2}`,
  },
  {
    id: 3,
    ...
    linkId: `series/${4}`,
    image: "https://images.unsplash.com/photo-1560746420-1b4dc6d92d17?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=388&q=80",
  },
];
...
const informationData = [
  {
    ...
    ctaText: "Cada compra esta asegurada y encriptada, no almacenamos sus datos delicados y somos transparentes en nuestras políticas.",
  },
  {
    id: 2,
    image: "https://i.postimg.cc/D0p57hjs/image-2.png",
    ctaTitle: "Lleva siempre a tus personajes favoritos ",
    ctaText: "Desde un póster hasta una camiseta, lleva a tus personajes favoritos a donde quieras y en cualquier producto. ",
  },
  {
    id: 3,
    image: "https://i.postimg.cc/TPj9pgNT/image-3.png",
    ctaTitle: "Garantizamos todo lo que hacemos",
    ctaText: "Porque sabemos que priorizar la durabilidad da como resultado consumir menos energía, desperdiciar menos agua y generar menos basura",
  },
  {
    id: 4,
    image: "https://i.postimg.cc/Qt4cTbQZ/image-4.png",
    ctaTitle: "Devolvemos cada venta",
    ctaText: "Hemos destinado el 5% de las ventas a la conservación y restauración del medio ambiente natural",
  },
];
